...
const products = [
    ...
    { id: 7, name: "Performance Gym Fit", price: 65.00, image: "https://placehold.co/600x600/2c2c2c/ffffff?text=Gym+Fit", category: "Athletic", description: "Designed for optimal performance and comfort during workouts. Made from moisture-wicking fabric with four-way stretch for unrestricted movement.", colors: ["Black", "Navy", "Charcoal"], sizes: ["S", "M", "L", "XL"] }
];
